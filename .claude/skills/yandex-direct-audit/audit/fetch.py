...
SPECS = {
    ...
    "campdays": dict(type="CUSTOM_REPORT",
    ...
    "targeting": dict(type="CUSTOM_REPORT",
                      fields=["CriterionType", "Impressions", "Clicks", "Cost", "Conversions"]),
    "geo": dict(type="CUSTOM_REPORT",
                fields=["LocationOfPresenceName", "Impressions", "Clicks", "Cost", "Conversions"]),
    "matchtype": dict(type="SEARCH_QUERY_PERFORMANCE_REPORT",
                      fields=["MatchType", "Impressions", "Clicks", "Cost", "Conversions"]),
    "traffic": dict(type="CUSTOM_REPORT",
                    fields=["CampaignName", "AvgTrafficVolume", "Impressions", "Clicks", "Cost",
                            "Conversions"],
                    filter=[{"Field": "AdNetworkType", "Operator": "EQUALS",
                             "Values": ["SEARCH"]}]),
